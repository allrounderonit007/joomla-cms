...
//	var $folder = '/Applications/XAMPP/xamppfiles/htdocs'; // typical MacOS example with XAMPP
	...
	var $path = '/joomla_development/cms-trunk/';
	...
	var $db_user = 'vedant12';
	var $db_pass = 'dumbanddumber';
	var $db_name = 'joomla_cms';
	var $db_type = 'MySQLi';
	var $db_prefix = 'lo1t2_';
	...
	var $site_name = 'lalsyahi';

	// set the admin login, admin password, and admin email address
	var $username = 'vedant12';
	var $password = 'dumbanddumber';
	var $admin_email = 'allrounderonit007@gmail.com';
